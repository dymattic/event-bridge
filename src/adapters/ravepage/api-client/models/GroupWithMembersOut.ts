...
export type GroupWithMembersOut = {
    ...
    location?: string;
    /**
     * Members - the enriched member list. Empty slice when the
     * group has no memberships. NEVER nil.
     */
    members?: Array<GroupMemberOut>;
    /**
