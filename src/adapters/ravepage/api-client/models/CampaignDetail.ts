...
/* tslint:disable */
/* eslint-disable */
import type { CampaignEffectivePermissions } from './CampaignEffectivePermissions';
...
export type CampaignDetail = {
    can_edit?: boolean;
    /**
     * Collaborators - collaborator-grant list.
     */
    ...
    description?: string;
    /**
     * EffectivePermissions - caller's resolved role + permission bag.
     */
    effective_permissions?: CampaignEffectivePermissions;
    /**
    ...
    /**
     * Steps - ordered campaign-step list.
     */
    steps?: Array<any>;
    /**
